...
def load_workouts_to_staging(workouts: List[Dict]) -> None:
    ...
    try:
        ...
        for workout in workouts:
            ...
            sql = """INSERT INTO hyrox_workouts_staging (
            ...
            for line in workout.get('description_lines', []):
                ...
                weight_text = None
                if movement_data.get('weight_value'):
                    weight_text = f"{movement_data['weight_value']}{movement_data.get('weight_unit', '')}"
                
                sql = """INSERT INTO hyrox_workout_lines_staging (
            ...
            cursor.execute(
                "INSERT INTO hyrox_workout_tags_staging (workout_id, tag_name) VALUES (%s, %s)",
